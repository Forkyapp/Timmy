#!/bin/bash
      ...
      export PROMPT_FILE="/Users/user/Documents/Personal-Projects/clickup-claude-github/task-86evckrqg-codex-review-prompt.txt"
      ...
      # Cleanup
      rm -f "$PROMPT_FILE"
      rm -f "/Users/user/Documents/Personal-Projects/clickup-claude-github/task-86evckrqg-codex-review.sh"
