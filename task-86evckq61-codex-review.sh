#!/bin/bash
      ...
      export PROMPT_FILE="/Users/user/Documents/Personal-Projects/clickup-claude-github/task-86evckq61-codex-review-prompt.txt"
      ...
      # Cleanup
      rm -f "$PROMPT_FILE"
      rm -f "/Users/user/Documents/Personal-Projects/clickup-claude-github/task-86evckq61-codex-review.sh"
