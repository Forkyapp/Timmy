...
Begin implementation now and make sure to create the PR when done!`;
  ...
  try {
    ...
    try {
      ...
      console.log(jarvis.error(`${colors.bright}Claude${colors.reset} execution failed: ${claudeError.message}`));
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        console.log(jarvis.warning(`Failed to auto-commit Claude fixes: ${gitError.message}`));
      ...
      console.log(jarvis.error(`${colors.bright}Claude${colors.reset} fix execution failed: ${claudeError.message}`));
